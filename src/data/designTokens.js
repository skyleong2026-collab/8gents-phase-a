...
export const DIM    = '#9A8E76';                 // disabled / secondary (warm taupe, was cold #8a8a9a)
export const PANEL  = BASE.panel;                // #1B160F — earthen panel (was cold blue-black #12121c)
export const LINE   = BASE.edge;                 // #3A3025 — warm rim (was cold #2a2a3a)
